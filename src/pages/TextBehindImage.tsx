      ...
      <div className="min-h-screen bg-background">
        <main className="container mx-auto px-4 py-8 overflow-y-auto">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Upload an image and add text layers to create stunning text-behind-image effects. Perfect for social media posts, marketing materials, and creative projects.
          </p>
          <section className="flex flex-col lg:flex-row gap-8">
                ...
                {imageUrl ? (
                  <>
                    <canvas
                      ...
                      aria-label="Canvas displaying the image with text layers"
                    />
                    {isLoading && (
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                    <ImageIcon className="w-16 h-16 text-muted-foreground mb-4" aria-hidden="true" />
            ...
            {imageUrl && (
              <div className="w-full lg:w-1/2 space-y-4">
                <h2 className="text-2xl font-semibold mb-4">Text Layers</h2>
...
// const TextBehindImageWithAuth = withAuth(TextBehindImage);
